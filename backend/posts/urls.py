...
urlpatterns = [
    # ----------------------------------------------------------------------
    # 1. POST Endpoints (Admin Create, Public Read)
    # ----------------------------------------------------------------------
    # Endpoint: /api/posts/
    ...
    # ----------------------------------------------------------------------
    # 2. COMMENT Endpoints (Authenticated Create, Author Manage)
    # ----------------------------------------------------------------------
    ...
    # Methods: GET (Retrieve), PUT/PATCH/DELETE (Update/Delete - Author or Admin only)
    path(
        "comments/<int:pk>/",
        comment_detail,
        name="comment-detail",
